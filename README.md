...
## Installation
clone the github app in your text editor. Run a npm i and then run an npm start.  Go to the local host directed by your terminal.  Go to top right corner
